...
INSERT INTO public.freelancer_specialties (freelancer_id, specialty) VALUES 
(gen_random_uuid(), 'audio_engineer'::specialty),
(gen_random_uuid(), 'camera_operator'::specialty),
(gen_random_uuid(), 'lighting_technician'::specialty),
(gen_random_uuid(), 'video_editor'::specialty),
(gen_random_uuid(), 'sound_designer'::specialty),
(gen_random_uuid(), 'live_streaming'::specialty),
(gen_random_uuid(), 'post_production'::specialty),
(gen_random_uuid(), 'drone_operator'::specialty)
