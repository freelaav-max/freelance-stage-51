...
const HeroSection: React.FC<{
  ...
  return <section ref={ref} className="relative bg-gradient-primary text-white overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-20 md:py-32 relative z-10">
        <div className="max-w-4xl">
          ...
          <motion.div className="flex items-center text-white/90" initial={{
          opacity: 0
        }} animate={inView ? {
          opacity: 1
        } : {}} transition={{
  ...
  return <section ref={ref} className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          return <motion.div key={index} className="text-center group" initial={{
            opacity: 0,
            y: 30
          }} animate={inView ? {
            opacity: 1,
...
const BenefitsSection: React.FC = () => {
  ...
  return <section ref={ref} className="py-20 bg-muted/50">
      <div className="container mx-auto px-4">
        <motion.div className="text-center mb-16" initial={{
        opacity: 0,
        y: 30
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          return <motion.div key={index} className="bg-background p-6 rounded-lg border hover:shadow-md transition-shadow" initial={{
            opacity: 0,
            y: 30
          }} animate={inView ? {
            opacity: 1,
...
const PricingSection: React.FC<{
  ...
  const plans = [{
    ...
    features: ["Perfil completo na plataforma", "Até 5 habilidades destacadas", "Receba até 10 ofertas por mês", "Comissão de 15% sobre trabalhos", "Suporte por email"],
    cta: "Começar grátis",
    popular: false
  }, {
    name: "PRO",
    ...
    features: ["Tudo do plano Básico", "Destaque nos resultados de busca", "Até 15 habilidades destacadas", "Ofertas ilimitadas", "Comissão reduzida de 10%", "Contratos personalizados", "Suporte prioritário"],
    ...
    features: ["Tudo do plano PRO", "Selo de verificação Premium", "Habilidades ilimitadas", "Comissão reduzida de 5%", "Destaque máximo nas buscas", "Estatísticas avançadas", "Suporte VIP 24/7"],
...
const FinalCTASection: React.FC<{
  ...
  return <section ref={ref} className="bg-gradient-primary text-white py-20">
      <div className="container mx-auto px-4 text-center">
        ...
        <motion.p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto" initial={{
        opacity: 0,
        y: 30
      }} animate={inView ? {
        opacity: 1,
